...
template<typename T>
struct CyberneticLayer
{
    using cybernetic_matrix = std::vector<CyberneticNeuron<T>*>;
    cybernetic_matrix neurons;
};
template<typename T>
struct CyberneticNetwork
{
    using cybernetic_layers = std::vector<CyberneticLayer<T>*>;
    cybernetic_layers layers;
    CyberneticLayer<T>* input;
    CyberneticLayer<T>* output;
};
