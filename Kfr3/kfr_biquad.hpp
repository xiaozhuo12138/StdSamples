...
namespace DSP {
    ...
    struct Biquad
    {
        ...
        void apply(sample_vector<T> & vector) 
        {                 
            filter->apply(vector);
        }
        void apply(const sample_vector<T> & src, sample_vector<T> & dst) 
        {
...
/////////////////////////////////////////////////////////
    ...
    template<typename T>
    sample_vector<T> biquad(const BiQuadParams<T> & bp, sample_vector<T> & input) {
        return sample_vector<T>(kfr::biquad(bp.bq,input));
    }

    // simple biquad filter functions
    template<typename T>
    sample_vector<T> allpassfilter(sample_vector<T> & input, T W, T q) {
        Biquad<T> filter;
        filter.allpass(W,q);
        sample_vector<T> r(input);
        filter.apply(input,r);
        return r;
    }
    // simple biquad filter functions
    template<typename T>
    sample_vector<T> lowpassfilter(sample_vector<T> & input, T W, T q) {
        Biquad<T> filter;
        filter.lowpass(W,q);
        sample_vector<T> r(input);
        filter.apply(input,r);
    ...
    template<typename T>
    sample_vector<T> highpassfilter(sample_vector<T> & input, T W, T q) {
        Biquad<T> filter;
        filter.highpass(W,q);
        sample_vector<T> r(input);
        filter.apply(input,r);
    ...
    template<typename T>
    sample_vector<T> notchfilter(sample_vector<T> & input, T W, T q) {
        Biquad<T> filter;
        filter.notch(W,q);
        sample_vector<T> r(input);
        filter.apply(input,r);
    ...
    template<typename T>
    sample_vector<T> bandpassfilter(sample_vector<T> & input, T W, T q) {
        Biquad<T> filter;
        filter.bandpass(W,q);
        sample_vector<T> r(input);
        filter.apply(input,r);
    ...
    template<typename T>
    sample_vector<T> peakfilter(sample_vector<T> & input, T W, T q, T gain) {
        Biquad<T> filter;
    ...
    template<typename T>
    sample_vector<T> lowshelffilter(sample_vector<T> & input, T W, T q) {
        Biquad<T> filter;
        filter.lowshelf(W,q);
        sample_vector<T> r(input);
        filter.apply(input,r);
    ...
    template<typename T>
    sample_vector<T> highshelffilter(sample_vector<T> & input, T W, T q) {
        Biquad<T> filter;
        filter.highshelf(W,q);
        sample_vector<T> r(input);
        filter.apply(input,r);
