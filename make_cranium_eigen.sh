...
gcc -DUSE_MKL -fmax-errors=1 -DMKL_ILP64-m64 -mavx2 -mfma  -I"${MKLROOT}/include" -O2 -march=native -mavx2 -o cranium cranium_eigen.cpp -lstdc++ -L/usr/local/cuda/lib64 -lnvblas -L${MKLROOT}/lib/intel64 -Wl,--no-as-needed -lmkl_rt -lmkl_intel_ilp64 -lmkl_core -lmkl_intel_thread -liomp5 -lpthread -lm -ldl -lfftw3 -lfftw3f -lsndfile  -lblas -llapacke -lboost_math_c99
