...
namespace Filters::cppfilters
{
    ...
    struct Biquad 
    {
        Biquad(coef_size_t sampleRate=44100.0) : sr(sampleRate),fc(1000.0),q(0.5),g(1.0),m_xnz1(0), m_xnz2(0), m_ynz1(0), m_ynz2(0), m_offset(0), m_coeffs{0} {};
        virtual ~Biquad() {};
