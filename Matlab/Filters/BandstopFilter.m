function FIR_bandstop = BandstopFilter(As, Fs, fp1, fs1, fs2, fp2, Kaiser)
...
% RETURNS
%           FIR_bandstop: FIR bandstop filter coefficients
...
% Ideal impulse response of bandstop filter
alpha = N/2;
h_id = zeros(1, N);
for n = 0 : N-1
    if n == alpha
