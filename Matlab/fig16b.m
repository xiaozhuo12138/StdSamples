% fig16b.m - four-step gain, linear bandwidth
%
% -------------------------------------------------------------------------
...
M = 250;                                % G increases in four-steps (1000/250 = 4)
nq = M * floor((0:N3)/M) + 1;
G = G(nq); GB = GB(nq); Gs = Gs(nq);    % define stepped gains
