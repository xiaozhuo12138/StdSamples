...
namespace Filters
{
    struct ChebyshevIHighShelfFilter : public FilterBase
    {
        Dsp::ChebyshevI::HighShelf<32> prototype;
                
        ChebyshevIHighShelfFilter(size_t Order, DspFloatType G, DspFloatType ripdb, DspFloatType Fc, DspFloatType Fs)
        {            
            order = Order;
            sr    = Fs;
            ripple=ripdb;            
