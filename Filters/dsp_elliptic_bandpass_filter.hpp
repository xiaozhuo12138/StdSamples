...
namespace Filters
{
   struct EllipticBandPassFilter : public FilterBase
    {
        Dsp::Elliptic::BandPass<32> prototype;
        
        EllipticBandPassFilter(size_t Order, DspFloatType BW, DspFloatType rip, DspFloatType roll, DspFloatType Fc, DspFloatType Fs)
        {            
            order = Order;
            sr    = Fs;
            bw    = BW;
