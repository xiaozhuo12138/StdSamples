 ...
 */
  ...
  inline float cblas_asum(const MKL_INT N, const std::complex<float> *X, const MKL_INT incX)
  {
    return cblas_scasum(N, static_cast<const void*>(X), incX);
  }
  ...
  inline double cblas_asum(const MKL_INT N, const std::complex<double> *X, const MKL_INT incX)
  {
  ...
  inline void cblas_axpy(const MKL_INT N, const float alpha, const std::complex<float> *X,
                 const MKL_INT incX, std::complex<float> *Y, const MKL_INT incY)
  {
    cblas_caxpy(N, static_cast<const void*>(&alpha), static_cast<const void*>(X), 
                incX, static_cast<void*>(Y), incY);
  }
  ...
  inline void cblas_axpy(const MKL_INT N, const double alpha, const std::complex<double> *X,
                 const MKL_INT incX, std::complex<double> *Y, const MKL_INT incY)
  {
    cblas_zaxpy(N, static_cast<const void *>(&alpha), static_cast<const void *>(X),
                incX, static_cast<void*>(Y), incY);
  }
  ...
  inline void cblas_copy(const MKL_INT N, const std::complex<float>* X, const MKL_INT incX, 
                         std::complex<float>* Y, const MKL_INT incY)
  {
    cblas_ccopy(N, static_cast<const void*>(X), incX, static_cast<void*>(Y), incY);    
  }
  inline void cblas_copy(const MKL_INT N, const std::complex<double>* X, const MKL_INT incX, 
 ...
 */
  ...
  inline void cblas_dotc(const MKL_INT N, const std::complex<float>* X, const MKL_INT incX, 
                         const std::complex<float>* Y, const MKL_INT incY, std::complex<float>& result)
  {
    cblas_cdotc_sub(N, static_cast<const void*>(X), incX, static_cast<const void*>(Y), incY, 
                   static_cast<void*>(&result));    
  }
  inline void cblas_dotc(const MKL_INT N, const std::complex<double>* X, const MKL_INT incX, 
                         const std::complex<double>* Y, const MKL_INT incY, std::complex<double>& result)
  {
    cblas_zdotc_sub(N, static_cast<const void*>(X), incX, static_cast<const void*>(Y), incY,
                          static_cast<void*>(&result));    
  }
  ...
  inline void cblas_dotu(const MKL_INT N, const std::complex<float>* X, const MKL_INT incX, 
                         const std::complex<float>* Y, const MKL_INT incY, std::complex<float>& result)
  {
    cblas_cdotu_sub(N, static_cast<const void*>(X), incX, static_cast<const void*>(Y), incY, 
                   static_cast<void*>(&result));    
  }
  inline void cblas_dotu(const MKL_INT N, const std::complex<double>* X, const MKL_INT incX, 
                         const std::complex<double>* Y, const MKL_INT incY, std::complex<double>& result)
  {
    cblas_zdotu_sub(N, static_cast<const void*>(X), incX, static_cast<const void*>(Y), incY,
                          static_cast<void*>(&result));    
  ...
  inline double cblas_nrm2(const MKL_INT N, const std::complex<float> *X, const MKL_INT incX)
  {
    return cblas_scnrm2(N, static_cast<const void*>(X), incX);
  }
  inline double cblas_nrm2(const MKL_INT N, const std::complex<double> *X, const MKL_INT incX)  
  {
    return cblas_dznrm2(N, static_cast<const void *>(X), incX);
  }
  template <typename VECTOR_T>
  ...
  inline void cblas_rot(const MKL_INT N, std::complex<float> *X, const MKL_INT incX,
                 std::complex<float> *Y, const MKL_INT incY, const float c, const float s)
  {
    cblas_csrot(N, static_cast<void*>(X), incX, 
              static_cast<void *>(Y), incY, c, s);
  }
  inline void cblas_rot(const MKL_INT N, std::complex<double> *X, const MKL_INT incX,
                 std::complex<double> *Y, const MKL_INT incY, const double c, const double s)
  {
    cblas_zdrot(N, static_cast<void*>(X), incX, 
              static_cast<void *>(Y), incY, c, s);
  }
  ...
  inline void cblas_rotg(std::complex<float>& a, std::complex<float>& b, float& c, std::complex<float>& s)
  {
    cblas_crotg(static_cast<void *>(&a), static_cast<const void *>(&b), &c, static_cast<void*>(&s));
  }
  inline void cblas_rotg(std::complex<double>& a, std::complex<double>& b, double& c, std::complex<double>& s)
  {
    cblas_zrotg(static_cast<void *>(&a), static_cast<const void *>(&b), &c, static_cast<void*>(&s));
  }
  ...
  inline void cblas_scal(const MKL_INT N, const std::complex<float>& alpha, std::complex<float> *X, const MKL_INT incX)
  {
    cblas_cscal(N, static_cast<const void *>(&alpha), static_cast<void *>(X), incX);
  }
  inline void cblas_scal(const MKL_INT N, const std::complex<double>& alpha, std::complex<double> *X, const MKL_INT incX)
  {
    cblas_zscal(N, static_cast<const void *>(&alpha), static_cast<void *>(X), incX);
  }
  ...
  inline void cblas_scal(const MKL_INT N, const float alpha, std::complex<float>* X, const MKL_INT incX)
  {
    cblas_csscal(N, alpha, static_cast<void *>(X), incX);
  }
  inline void cblas_scal(const MKL_INT N, const double alpha, std::complex<double> *X, const MKL_INT incX)
  {
    cblas_zdscal(N, alpha, static_cast<void *>(X), incX);
  }
  ...
  inline void cblas_swap(const MKL_INT N, std::complex<float> *X, const MKL_INT incX,
                 std::complex<float> *Y, const MKL_INT incY) 
  {
    cblas_cswap(N, static_cast<void *>(X), incX, static_cast<void *>(Y), incY);
  }
  inline void cblas_swap(const MKL_INT N, std::complex<double> *X, const MKL_INT incX,
                 std::complex<double> *Y, const MKL_INT incY)   {
    cblas_zswap(N, static_cast<void *>(X), incX, static_cast<void *>(Y), incY);
  }
  template<typename VECTOR_T>
  ...
  inline CBLAS_INDEX cblas_iamax(const MKL_INT N, const std::complex<float> *X, const MKL_INT incX)
  {
    return cblas_icamax(N, static_cast<const void *>(X), incX);
  }
  inline CBLAS_INDEX cblas_iamax(const MKL_INT N, const std::complex<double> *X, const MKL_INT incX)
  {
    return cblas_izamax(N, static_cast<const void*>(X), incX);
  }
  template<typename VECTOR_T>
  ...
  inline CBLAS_INDEX cblas_iamin(const MKL_INT N, const std::complex<float> *X, const MKL_INT incX)
  {
    return cblas_icamin(N, static_cast<const void *>(X), incX);
  }
  inline CBLAS_INDEX cblas_iamin(const MKL_INT N, const std::complex<double> *X, const MKL_INT incX)
  {
    return cblas_izamin(N, static_cast<const void*>(X), incX);
  }
  ...
  inline double cblas_cabs1(const std::complex<double>& z)
  {
    return cblas_dcabs1(static_cast<const void*>(&z));
  }
 ...
 */
  ...
  inline void cblas_gemv(const  CBLAS_ORDER order,
                 const  CBLAS_TRANSPOSE TransA, const MKL_INT M, const MKL_INT N,
                 const std::complex<float>& alpha, const std::complex<float>*A, const MKL_INT lda,
                 const std::complex<float> *X, const MKL_INT incX, const std::complex<float>& beta,
                 std::complex<float> *Y, const MKL_INT incY)
  {
    cblas_cgemv(order, TransA, M, N, static_cast<const void*>(&alpha), static_cast<const void*>(A), lda, 
                static_cast<const void*>(X), incX, static_cast<const void*>(&beta), static_cast<void*>(Y), incY);
  ...
  inline void cblas_gemv(const  CBLAS_ORDER order,
                 ...
                 const std::complex<double> *X, const MKL_INT incX, const std::complex<double>& beta,
                 std::complex<double> *Y, const MKL_INT incY)
  {
    cblas_zgemv(order, TransA, M, N, static_cast<const void*>(&alpha), static_cast<const void*>(A), lda, 
                static_cast<const void*>(X), incX, static_cast<const void*>(&beta), static_cast<void*>(Y), incY);
