...
namespace Stk 
{
    ...
    struct BlowHole : public GeneratorProcessor, public stk::BlowHole
    {
        BlowHole(DspFloatType lowFreq) : GeneratorProcessor(), stk::BlowHole(lowFreq)
        {
    ...
    struct Clarinet : public GeneratorProcessorPlugin<stk::Clarinet>
    {
        ...
        // todo: ports
    struct Flute : public GeneratorProcessor, public stk::Flute
    {
        Flute(DspFloatType lowFreq) : GeneratorProcessor(),stk::Flute(lowFreq)
        {
    ...
    struct Guitar : public GeneratorProcessorPlugin<stk::Guitar>
    {
        ...
        void setPort2(int port, DspFloatType a, DspFloatType b) {
            switch(port) {
                case PORT_NOTEON: this->noteOn(a,b); break;
                case PORT_CC: this->controlChange(a,b); break;
                case PORT_PLUCKPOS: this->setPluckPosition(a,b); break;
    ...
    // todo: ports
    struct Mandolin : public GeneratorProcessor,stk::Mandolin
    {
        Mandolin(DspFloatType lowFreq) : GeneratorProcessor(),stk::Mandolin(lowFreq)
        {
    ...
    // todo: ports
    struct Mesh2D : public GeneratorProcessor, stk::Mesh2D
    {
        Mesh2D(unsigned short nX, unsigned short nY) : GeneratorProcessor(),stk::Mesh2D(nX,nY)
        {
    ...
    struct Modal : public GeneratorProcessorPlugin<stk::Modal>
    {
        ...
        void setPort2(int port, DspFloatType a, DspFloatType b) {
            switch(port) {
                ...
                case PORT_MODEGAIN: this->setModeGain(a,b); break;
                default: printf("No port %d\n",port);
            }
        }
        DspFloatType Tick(DspFloatType I=0, DspFloatType A=1, DspFloatType X=1, DspFloatType Y=1)
    ...
    */
    ...
    struct ReedTable : public FunctionProcessorPlugin<stk::ReedTable>
    {
        ...
        // todo: ports
    struct Saxophony : public GeneratorProcessor,stk::Saxofony
    {
        Saxophony(DspFloatType lowFrq) : GeneratorProcessor(),stk::Saxofony(lowFrq)
        {
