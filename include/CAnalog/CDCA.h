...
namespace Analog::CAnalog
{
	struct CDCA : public StereoAmplifierProcessor
	{
		...
		{
			m_dAmplitude_dB = d;
			m_dAmplitudeControl = pow((DspFloatType)10.0, m_dAmplitude_dB/(DspFloatType)20.0);
		}
		...
		inline void update()
		{
			...
			m_dGain *= pow(10.0, m_dAmpMod_dB/(DspFloatType)20.0);
