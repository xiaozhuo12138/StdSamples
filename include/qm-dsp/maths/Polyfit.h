...
inline double TPolyFit::PolyFit2 (const vector<double> &x,
                           const vector<double> &y,
                           vector<double> &coefs)
// nterms = coefs.size()
// npoints = x.size()
...
inline void TPolyFit::Square (const Matrix &x,
                       const vector<double> &y,
                       Matrix &a,
                       vector<double> &g,
                       const int nrow,
...
inline bool TPolyFit::GaussJordan (Matrix &b,
                            const vector<double> &y,
                            vector<double> &coef)
...
inline bool TPolyFit::GaussJordan2(Matrix &b,
                            const vector<double> &y,
                            Matrix &w,
                            vector<vector<int> > &index)
{
