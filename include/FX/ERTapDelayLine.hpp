...
namespace FX::Delays
{
    ...
    public:
        ...
        DspFloatType tapNumSamplesFromMSf(const int sr, const DspFloatType d_ms);
    ...
    // passed to function
    //-------------------------------------------------------------------------
    inline DspFloatType ERTapDelayLine::tapNumSamplesFromMSf(const int sr, const DspFloatType d_ms){
        return sr * d_ms;
    }
    ...
    //----------------------------------------------------------------------
    inline DspFloatType ERTapDelayLine::linInterp(DspFloatType x1, DspFloatType x2, DspFloatType y1, DspFloatType y2, DspFloatType x){
