...
namespace FX::HammerFX
{
    ...
    void distort_filter(struct distort_params * dp, size_t numSamples, DspFloatType *input, DspFloatType * buffer);
    ...
    void distort2_filter(struct distort2_params * dp, size_t numSamples, DspFloatType * input, DspFloatType * buffer);
