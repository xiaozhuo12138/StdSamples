...
namespace FX::WaveShaping
{
    ...
    T tanclip (T x) noexcept
    {
        ...
        return std::clamp(static_cast<DspFloatType>((DspFloatType)std::tanh ((1.0f - 0.5f * soft) * x) - 0.02 * x),(DspFloatType)-1.0f, (DspFloatType)1.0f );
    }
