        ...
        */
        ...
        void setPort(int port, DspFloatType v) {
            switch(port) {
                ...
                case PORT_LP: type = LOW; break;
                case PORT_HP: type = HIGH; break;
                case PORT_BP: type = BAND; break;
                case PORT_NOTCH: type = NOTCH; break;               
                case PORT_TARGET: setTarget(v); break;
            }
        }
        DspFloatType Tick(DspFloatType In=1, DspFloatType A=1, DspFloatType X=1, DspFloatType Y=1)
        {
            Undenormal denormal;
