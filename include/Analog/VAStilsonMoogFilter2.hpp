...
namespace Analog::Filters::Moog::StilsonMoogFilter2
{
    struct StilsonMoog : public FilterProcessor
    {
        ...
        StilsonMoog(DspFloatType Fc, DspFloatType R, DspFloatType Fs) : FilterProcessor() {        
            fs = Fs;        
            cutoff = Fc;
            resonance = R;
            pre_gain = 2.0f;
        ...
        void setPort(int port, DspFloatType v) {
            switch(port) {
                ...
                case PORT_POSTGAIN: post_gain = v; break;
            }
        }
