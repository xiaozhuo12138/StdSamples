...
namespace Analog::Filters::SmoothSVF
{
    struct SmoothSVF
    {
        ...
        */
        ...
        {
            Undenormal denormal;
            cutoff = MusicFunctions::cv2freq(cutSmooth.process(fabs(Ftarget*X)));        
            ...
            case LPHMORPH: return A/scale*LPHMorph(morph);
            case LPBMORPH: return A/scale*LPBMorph(morph);
            case LPNMORPH: return A/scale*LPNMorph(morph);
            }
