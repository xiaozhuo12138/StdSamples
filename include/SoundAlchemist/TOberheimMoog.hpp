...
public:
	...
	{
		LPF1 = new TVAOnePole<T>(sampleRate);
		LPF2 = new TVAOnePole<T>(sampleRate);
		LPF3 = new TVAOnePole<T>(sampleRate);
		LPF4 = new TVAOnePole<T>(sampleRate);
