...
{
    template<typename T>
    struct TEQFilter : public TObject<T>
    {
        T last,y;
        T a0,a1,a2,b1,b2;
        T x1,x2,y1,y2;
...
using EQFilter32 = SoundAlchemy::Filters::TEQFilter<float>;
using EQFilter64 = SoundAlchemy::Filters::TEQFilter<double>;