...
namespace Filters
{
    ...
    struct BandpassButterworth
    {
        ...
        BandpassButterworth(size_t O,DspFloatType lower, DspFloatType upper, DspFloatType sr)
        {
            fs = sr;            
            order = O;
        ...
        void setCutoff(DspFloatType l, DspFloatType u)
        {
            ...
            spuce::butterworth_iir(filter.coef,(f2+f1)/2.0,a);
