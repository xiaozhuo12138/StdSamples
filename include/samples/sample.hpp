...
using std::vector;
template<typename T> using sample_vector = std::vector<T,Allocator::aligned_allocator<T,32>>;
template<typename T> using complex_vector = std::vector<std::complex<T>,Allocator::aligned_allocator<std::complex<T>,32>>;
