...
#define SWIGTYPE_p_CSEMFilter swig_types[2]
...
#define SWIGTYPE_p_p_CSEMFilter swig_types[52]
...
#define SWIG_name      "csemfilter"
#define SWIG_init      luaopen_csemfilter
#define SWIG_init_user luaopen_csemfilter_user

#define SWIG_LUACODE   luaopen_csemfilter_luacode
...
static int _wrap_new_CSEMFilter(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *result = 0 ;
  
  SWIG_check_num_args("CSEMFilter::CSEMFilter",0,0)
  result = (CSEMFilter *)new CSEMFilter();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_CSEMFilter,1); SWIG_arg++; 
  return SWIG_arg;
...
static int _wrap_CSEMFilter_m_dAlpha0_set(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("CSEMFilter::m_dAlpha0",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::m_dAlpha0",1,"CSEMFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CSEMFilter::m_dAlpha0",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_m_dAlpha0_set",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _wrap_CSEMFilter_m_dAlpha0_get(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("CSEMFilter::m_dAlpha0",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::m_dAlpha0",1,"CSEMFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_m_dAlpha0_get",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _wrap_CSEMFilter_m_dAlpha_set(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("CSEMFilter::m_dAlpha",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::m_dAlpha",1,"CSEMFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CSEMFilter::m_dAlpha",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_m_dAlpha_set",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _wrap_CSEMFilter_m_dAlpha_get(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("CSEMFilter::m_dAlpha",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::m_dAlpha",1,"CSEMFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_m_dAlpha_get",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _wrap_CSEMFilter_m_dRho_set(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("CSEMFilter::m_dRho",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::m_dRho",1,"CSEMFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CSEMFilter::m_dRho",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_m_dRho_set",1,SWIGTYPE_p_CSEMFilter);
  }
  
  arg2 = (DspFloatType)lua_tonumber(L, 2);
  if (arg1) (arg1)->m_dRho = arg2;
...
static int _wrap_CSEMFilter_m_dRho_get(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType result;
  
  SWIG_check_num_args("CSEMFilter::m_dRho",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::m_dRho",1,"CSEMFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_m_dRho_get",1,SWIGTYPE_p_CSEMFilter);
  }
  
  result = (DspFloatType) ((arg1)->m_dRho);
  lua_pushnumber(L, (lua_Number) result); SWIG_arg++;
  return SWIG_arg;
...
static int _wrap_CSEMFilter_reset(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  
  SWIG_check_num_args("CSEMFilter::reset",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::reset",1,"CSEMFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_reset",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _wrap_CSEMFilter_setQControl(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType arg2 ;
  
  SWIG_check_num_args("CSEMFilter::setQControl",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::setQControl",1,"CSEMFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CSEMFilter::setQControl",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_setQControl",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _wrap_CSEMFilter_update(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  
  SWIG_check_num_args("CSEMFilter::update",1,1)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::update",1,"CSEMFilter *");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_update",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _wrap_CSEMFilter_doFilter(lua_State* L) {
  int SWIG_arg = 0;
  CSEMFilter *arg1 = (CSEMFilter *) 0 ;
  DspFloatType arg2 ;
  DspFloatType result;
  
  SWIG_check_num_args("CSEMFilter::doFilter",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("CSEMFilter::doFilter",1,"CSEMFilter *");
  if(!lua_isnumber(L,2)) SWIG_fail_arg("CSEMFilter::doFilter",2,"DspFloatType");
  
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_CSEMFilter,0))){
    SWIG_fail_ptr("CSEMFilter_doFilter",1,SWIGTYPE_p_CSEMFilter);
  }
...
static int _proxy__wrap_new_CSEMFilter(lua_State *L) {
    assert(lua_istable(L,1));
    lua_pushcfunction(L,_wrap_new_CSEMFilter);
    assert(!lua_isnil(L,-1));
    lua_replace(L,1); /* replace our table with real constructor */
    lua_call(L,lua_gettop(L)-1,1);
    return 1;
}
static swig_lua_attribute swig_CSEMFilter_attributes[] = {
    { "m_dAlpha0", _wrap_CSEMFilter_m_dAlpha0_get, _wrap_CSEMFilter_m_dAlpha0_set },
    { "m_dAlpha", _wrap_CSEMFilter_m_dAlpha_get, _wrap_CSEMFilter_m_dAlpha_set },
    { "m_dRho", _wrap_CSEMFilter_m_dRho_get, _wrap_CSEMFilter_m_dRho_set },
    {0,0,0}
};
static swig_lua_method swig_CSEMFilter_methods[]= {
    { "reset", _wrap_CSEMFilter_reset},
...
static swig_lua_attribute swig_CSEMFilter_Sf_SwigStatic_attributes[] = {
    {0,0,0}
};
static swig_lua_const_info swig_CSEMFilter_Sf_SwigStatic_constants[]= {
    {0,0,0,0,0,0}
};
static swig_lua_method swig_CSEMFilter_Sf_SwigStatic_methods[]= {
    {0,0}
};
static swig_lua_class* swig_CSEMFilter_Sf_SwigStatic_classes[]= {
    0
};

static swig_lua_namespace swig_CSEMFilter_Sf_SwigStatic = {
    "CSEMFilter",
    swig_CSEMFilter_Sf_SwigStatic_methods,
    swig_CSEMFilter_Sf_SwigStatic_attributes,
    swig_CSEMFilter_Sf_SwigStatic_constants,
    swig_CSEMFilter_Sf_SwigStatic_classes,
    0
};
static swig_lua_class *swig_CSEMFilter_bases[] = {0,0};
static const char *swig_CSEMFilter_base_names[] = {"CFilter *",0};
static swig_lua_class _wrap_class_CSEMFilter = { "CSEMFilter", "CSEMFilter", &SWIGTYPE_p_CSEMFilter,_proxy__wrap_new_CSEMFilter, swig_delete_CSEMFilter, swig_CSEMFilter_methods, swig_CSEMFilter_attributes, &swig_CSEMFilter_Sf_SwigStatic, swig_CSEMFilter_meta, swig_CSEMFilter_bases, swig_CSEMFilter_base_names };
...
static void *_p_CSEMFilterTo_p_CFilter(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((CFilter *)  ((CSEMFilter *) x));
}
static void *_p_CFilterTo_p_FilterProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FilterProcessor *)  ((CFilter *) x));
}
static void *_p_CSEMFilterTo_p_FilterProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FilterProcessor *) (CFilter *) ((CSEMFilter *) x));
}
...
static void *_p_CSEMFilterTo_p_MonoProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MonoProcessor *) (FilterProcessor *)(CFilter *) ((CSEMFilter *) x));
}
...
static void *_p_CSEMFilterTo_p_SoundProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((SoundProcessor *) (MonoProcessor *)(FilterProcessor *)(CFilter *) ((CSEMFilter *) x));
}
...
static void *_p_p_CSEMFilterTo_p_p_FilterProcessor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((FilterProcessor **) (CFilter *) ((CSEMFilter **) x));
}
...
static swig_type_info _swigt__p_CSEMFilter = {"_p_CSEMFilter", "CSEMFilter *", 0, 0, (void*)&_wrap_class_CSEMFilter, 0};
...
static swig_type_info _swigt__p_p_CSEMFilter = {"_p_p_CSEMFilter", 0, 0, 0, 0, 0};
...
static swig_cast_info _swigc__p_CFilter[] = {  {&_swigt__p_CFilter, 0, 0, 0},  {&_swigt__p_CSEMFilter, _p_CSEMFilterTo_p_CFilter, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_CSEMFilter[] = {  {&_swigt__p_CSEMFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_FilterProcessor[] = {  {&_swigt__p_CFilter, _p_CFilterTo_p_FilterProcessor, 0, 0},  {&_swigt__p_CSEMFilter, _p_CSEMFilterTo_p_FilterProcessor, 0, 0},  {&_swigt__p_FilterProcessor, 0, 0, 0},{0, 0, 0, 0}};
...
static swig_cast_info _swigc__p_p_CSEMFilter[] = {{&_swigt__p_p_CSEMFilter, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_p_FilterProcessor[] = {  {&_swigt__p_p_CFilter, _p_p_CFilterTo_p_p_FilterProcessor, 0, 0},  {&_swigt__p_p_CSEMFilter, _p_p_CSEMFilterTo_p_p_FilterProcessor, 0, 0},  {&_swigt__p_p_FilterProcessor, 0, 0, 0},{0, 0, 0, 0}};
