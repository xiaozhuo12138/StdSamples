...
GCC_MINOR=4
AR=ar
CFLAGS=-Wall -O2 -fPIC -march=native -mavx2 -Wdeclaration-after-statement -fno-strict-aliasing -Wno-pointer-sign -Wno-sign-compare -Wno-unused-result -Wno-format-truncation
LDFLAGS=
LIBSUF=.a
EXESUF=
DLLSUF=.so
